...
- no repositorio acima tem a collection para usar no postman: challenge-contacts-api.postman_collection.json, baixe e importe no postman.
...
1. **Criar um novo contato (POST)**
   - `https://challenge-contacts-api-dev-1-1.onrender.com/contacts/save`
     ...
     **BODY REQUEST:**
     ```json
     {
       "contactName": "test2024",
       "contactEmail": "testpost2024@example.com",
...
5. **Atualizar contato (PUT)**
   - `https://challenge-contacts-api-dev-1-1.onrender.com/contacts//update/{contactId}/address/{addressId}`
     ...
     **BODY REQUEST:**
       ```json
     {
       "contactName": "teste2024",
       "contactEmail": "test2024@example.com",
       "contactPhone": "+55 11 1234-5678",
       "dateOfBirth": "08/05/1989",
       "addressId": 1,
       "street": "Rua Teste2024",
       "cep": "12345-678",
       "number": 123,
       "active": true   
     }
